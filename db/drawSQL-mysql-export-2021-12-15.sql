CREATE TABLE `Login`(
    ...
    `use_class (?)` INT NOT NULL
);
ALTER TABLE
    `Login` ADD PRIMARY KEY `login_id_primary`(`id`);
CREATE TABLE `Users`(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `Nome` INT NOT NULL
);
...
ALTER TABLE
    `Utente` ADD PRIMARY KEY `utente_id_primary`(`id`);
...
ALTER TABLE
    `Receitas` ADD PRIMARY KEY `receitas_id_primary`(`id`);
CREATE TABLE `Stock`(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `nome_med` VARCHAR(255) NOT NULL,
...
ALTER TABLE
    `Stock` ADD PRIMARY KEY `stock_id_primary`(`id`);
...
ALTER TABLE
    `User_utente` ADD PRIMARY KEY `user_utente_id_primary`(`id`);
...
ALTER TABLE
    `utente_receitas` ADD PRIMARY KEY `utente_receitas_id_primary`(`id`);
...
ALTER TABLE
    `Localizaçao` ADD PRIMARY KEY `localizaçao_id_primary`(`id`);
...
ALTER TABLE
    `utente_localizaçao` ADD PRIMARY KEY `utente_localizaçao_id_primary`(`id`);
...
ALTER TABLE
    `utente_tasks` ADD PRIMARY KEY `utente_tasks_id_primary`(`id`);
CREATE TABLE `tasks`(
    `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
ALTER TABLE
    `time_table` ADD PRIMARY KEY `time_table_id_primary`(`id`);
...
ALTER TABLE
    `utente_stock` ADD PRIMARY KEY `utente_stock_id_primary`(`id`);
ALTER TABLE
